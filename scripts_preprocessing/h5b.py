...
if __name__ == "__main__":
    ...
    input_file = "/media/adarsh/One Touch/EventSLAM/TUM-VIE/mocap-1d-trans-vi_gt_data/mocap_data.txt"
    output_file = "/media/adarsh/One Touch/EventSLAM/dataset/train/mocap_1d_trans/pose.txt"
