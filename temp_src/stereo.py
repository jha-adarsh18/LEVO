...
def compute_stereo_scale(kp_left_1, kp_left_2, kp_right_1, kp_right_2, 
    ...
    points_3d_1, valid_1 = triangulate_points(kp_left_1, kp_right_1, K, K, baseline)
    ...
    for b in range(B):
        ...
        scales.append(median_depth.item())
    
    return torch.tensor(scales, device=device)
...
def stereo_consistency_check(kp_left, kp_right, desc_left, desc_right, 
    ...
    final_valid = valid_matches & epipolar_valid
...
class StereoProcessor:
    ...
    def process_stereo_pair(self, pred_left, pred_right):
        ...
        valid_stereo = stereo_consistency_check(
            kp_left, kp_right, desc_left, desc_right,
            self.epipolar_threshold, self.descriptor_threshold
        )
        
        points_3d, valid_tri = triangulate_points(
            kp_left, kp_right, self.K_left, self.K_right, 
    ...
    def recover_scale(self, pred_left_1, pred_left_2, pred_right_1, pred_right_2):
        ...
        kp_left_2 = pred_left_2['keypoints1']
        kp_right_1 = pred_right_1['keypoints1']
        kp_right_2 = pred_right_2['keypoints1']
        desc_left_1 = pred_left_1['descriptors1']
        desc_right_1 = pred_right_1['descriptors1']
        
        scales = compute_stereo_scale(
            kp_left_1, kp_left_2, kp_right_1, kp_right_2,
            desc_left_1, desc_right_1, self.K_left, self.baseline,
            self.min_scale_points
        )
